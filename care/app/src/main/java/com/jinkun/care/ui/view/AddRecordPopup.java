 ...
 */
public class AddRecordPopup extends BasePopupWindow implements View.OnClickListener {
    ...
    public AddRecordPopup(Activity context, String title, String hintName, String hintTime) {
        super(context);
        mContext = context;
        ...
        mEtInputName.setHint(hintName);
        mEtInputTime.setHint(hintTime);
...
//        setAutoShowInputMethod(true);
    ...
    public View onCreatePopupView() {
        return LayoutInflater.from(getContext()).inflate(R.layout.popup_input_new_record, null);
    }
