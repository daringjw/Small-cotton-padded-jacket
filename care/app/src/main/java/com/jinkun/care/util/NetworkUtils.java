...
public class NetworkUtils {
    ...
    /**
     * Check if there is any connectivity to a Wifi network. <p/> Can be used in combination with
     * {@link #isConnectedMobile} to provide different features if the device is on a wifi network
     * or a cell network.
     *
     * @param context The current Context or Activity that this method is called from
    ...
    /**
     * Check if there is any connectivity to a mobile network <p/> Can be used in combination with
     * {@link #isConnectedWifi} to provide different features if the device is on a wifi network or
     * a cell network.
     *
     * @param context The current Context or Activity that this method is called from
